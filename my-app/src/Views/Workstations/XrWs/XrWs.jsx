...
export const XrWs = () => {
    ...
    const [items2, setItems2] = useState([{ id: 1, name: 'New Station' }]);// Send the information to the StationSelect component
    ...
    return (
        <div>
            ...
            {wsName && <StationInfo items2={items2} setItems2={setItems2}></StationInfo>}
        </div>
    );
}
